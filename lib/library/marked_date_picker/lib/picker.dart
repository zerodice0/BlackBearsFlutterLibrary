...
///    [MarkedCalendarDatePicker] and provides an optional compact view where the
///    user can enter a date as a line of text.
///  * [showTimePicker], which shows a dialog that contains a material design
///    time picker.
///
class MarkedCalendarDatePicker extends StatefulWidget {
  ...
  @override
  State<MarkedCalendarDatePicker> createState() =>
      _MarkedCalendarDatePickerState();
}

class _MarkedCalendarDatePickerState extends State<MarkedCalendarDatePicker> {
  ...
  @override
  void didUpdateWidget(MarkedCalendarDatePicker oldWidget) {
...
class _MonthPickerState extends State<_MonthPicker> {
  ...
  void _handleMonthPageChanged(int monthPage) {
    ...
    widget.updateMonthCallback?.call(monthDate.year, monthDate.month);
          ...
          Expanded(
            child: FocusableActionDetector(
              ...
              child: _FocusedDate(
                ...
                child: widget.markedDatesListenable != null
                    ? ValueListenableBuilder<List<DateTime>>(
                        valueListenable: widget.markedDatesListenable!,
                        builder: (BuildContext context,
                            List<DateTime> markedDates, Widget? child) {
    ...
    while (day < daysInMonth) {
      ...
      if (day < 1) {
        ...
        final bool isMarked = widget.markedDates
            .any((day) => DateUtils.isSameDay(day, dayToBuild));
...
/// [MarkedCalendarDatePicker], or [showDatePicker] which create full date pickers.
///
/// See also:
///
///  * [MarkedCalendarDatePicker], which provides a Material Design date picker
///    interface.
///
